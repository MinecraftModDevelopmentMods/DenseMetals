...
public class DenseMetalsConfig {
	...
	public static void readConfig() {
		...
		prefModid = cfg.getString("Preferred Mod", "general", prefModid, "The modid that will take precedence when calculating the drops, exp, and hardness/resistance of dense ores.");
