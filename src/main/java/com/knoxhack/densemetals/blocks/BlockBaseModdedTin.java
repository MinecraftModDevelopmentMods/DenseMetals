...
public class BlockBaseModdedTin extends Block {
	
	public BlockBaseModdedTin(final Material material, final MapColor mapColor, final String blockName) {
	...
	public BlockBaseModdedTin(final Material materialIn, final String blockName) {
    ...
    public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        Item item = Item.getItemFromBlock(Materials.getMaterialByName("tin").getBlock("ore"));
