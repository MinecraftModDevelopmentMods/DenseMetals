...
public class BlockBase extends Block {
    ...
    public BlockBase(final Material materialIn, final String blockName, Block breakItem) {
        this(materialIn, materialIn.getMaterialMapColor(), blockName, Item.getItemFromBlock(breakItem));
    }
