...
public class BlockBaseModdedZinc extends Block {
	...
	public BlockBaseModdedZinc(final Material material, final MapColor mapColor, final String blockName) {
	...
	public BlockBaseModdedZinc(final Material materialIn, final String blockName) {
    ...
    public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        Item item = Item.getItemFromBlock(Materials.getMaterialByName("zinc").getBlock("ore"));
