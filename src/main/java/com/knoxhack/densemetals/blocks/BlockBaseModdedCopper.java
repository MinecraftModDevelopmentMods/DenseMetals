...
public class BlockBaseModdedCopper extends Block {
	
	public BlockBaseModdedCopper(final Material material, final MapColor mapColor, final String blockName) {
	...
	public BlockBaseModdedCopper(final Material materialIn, final String blockName) {
