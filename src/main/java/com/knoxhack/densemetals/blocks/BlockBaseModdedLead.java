...
public class BlockBaseModdedLead extends Block {
	
	public BlockBaseModdedLead(final Material material, final MapColor mapColor, final String blockName) {
	...
	public BlockBaseModdedLead(final Material materialIn, final String blockName) {
    ...
    public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        Item item = Item.getItemFromBlock(Materials.getMaterialByName("lead").getBlock("ore"));
